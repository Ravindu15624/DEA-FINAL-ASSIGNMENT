<%-- 
    Document   : Admin
    Created on : May 21, 2022, 7:06:42 PM
    Author     : Ravindu
--%>
...
<head>
    ...
    <title>ADMIN / PhoenixAirline</title>
...
<div class="recent-grid">
    ...
    <div class="recent-grid">
        ...
        <div class="card">
            <div class="card-header"> 
                 <h3>STAFF</h3>
                 <a href="AddStaffPart02.jsp"><Button>ADD</Button></a>
                 <a href="UpdateStaff.jsp"><Button>UPDATE</Button></a>
                 <a href="DeleteStaff.jsp"><Button>DELETE</Button></a>

...
<head>
    ...
    <title>DELETE FLIGHT / PhoenixAirline</title>
...
<div class="recent-grid">
    ...
    <div class="card">
        <div class="card-header"> 
             <h3>SEARCH THE FLIGHT FOR DELETE</h3>
        </div>
        <div class="card-body">
            ...
            <td><a href="DF.jsp?id=<%=resultSet.getString("id") %>"><button type="button"  class="delete">Delete</button></a></td>
            </tr>
            <%
            i++;
            }

<%-- 
    ...
    Created on : May 23, 2022, 4:10:38 PM
    Author     : Ravindu
--%>
...
<head>
    ...
    <title>DELETE CLIENT / PhoenixAirline</title>
...
<div class="recent-grid">
    ...
    <div class="card">
        <div class="card-header"> 
             <h3>SEARCH THE CLIENT FOR DELETE</h3>
        </div>
        <div class="card-body">
            ...
            <td><a href="DC.jsp?id=<%=resultSet.getString("id") %>"><button type="button"  class="delete">Delete</button></a></td>
            </tr>
            <%
            i++;
            }
